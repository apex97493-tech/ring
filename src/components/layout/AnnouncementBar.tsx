...
export default function AnnouncementBar() {
  ...
  return (
    <div className="bg-[#D4AF37] text-[#022C22] text-center h-7 sm:h-8 px-2 sm:px-4 text-[9px] sm:text-[11px] font-sans font-bold tracking-[0.12em] sm:tracking-[0.2em] uppercase border-b border-[#022C22]/15 flex items-center justify-center gap-1.5 sm:gap-2.5 select-none overflow-hidden transition-all shadow-xs">
      <Icon className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#022C22] flex-shrink-0" strokeWidth={2.2} />
